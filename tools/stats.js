...
module.exports = {
    ...
    convert: (stats, user, platform) => {
        ...
        result.group.solo["timePlayed"] = timeConvert(
            result.group.solo["timePlayed"]
        );
        result.group.duo["timePlayed"] = timeConvert(
            result.group.duo["timePlayed"]
        );
        result.group.squad["timePlayed"] = timeConvert(
            result.group.squad["timePlayed"]
        );
        ...
        result.lifetimeStats["top3s"] =
            result.group.solo["top3"] +
            result.group.duo["top3"] +
            result.group.squad["top3"];
        result.lifetimeStats["top5s"] =
            result.group.solo["top5"] +
            result.group.duo["top5"] +
            result.group.squad["top5"];
        result.lifetimeStats["top6s"] =
            result.group.solo["top6"] +
            result.group.duo["top6"] +
            result.group.squad["top6"];
        result.lifetimeStats["top10s"] =
            result.group.solo["top10"] +
            result.group.duo["top10"] +
            result.group.squad["top10"];
        result.lifetimeStats["top12s"] =
            result.group.solo["top12"] +
            result.group.duo["top12"] +
            result.group.squad["top12"];
        result.lifetimeStats["top25s"] =
            result.group.solo["top25"] +
            result.group.duo["top25"] +
            result.group.squad["top25"];
