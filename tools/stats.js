function timeConvert(time) {
    let result = "", d = parseInt(time/24/60), h = parseInt(time/60%24), m = parseInt(time%60);
    ...
    convert: (stats, user, platform) => {
      return new Promise ((resolve) => {
        ...
        stats.forEach((elem)  => {
          ...
          else if (key.indexOf("placetop5") !== -1) type = "top5";//top 5
          else if (key.indexOf("placetop6") !== -1) type = "top6";//top 6
          else if (key.indexOf("placetop10") !== -1) type = "top10";//top 10
          else if (key.indexOf("placetop12") !== -1) type = "top12";//top 12
          else if (key.indexOf("placetop25") !== -1) type = "top25";//top 25
          else if (key.indexOf("matchesplayed") !== -1) type = "matches";//matches
          else if (key.indexOf("kills") !== -1) type = "kills";//kills
          else if (key.indexOf("score") !== -1) type = "score";//score
          else if (key.indexOf("minutesplayed") !== -1) {//minutes played
